        ...
        <div className="relative z-10 container-narrow mx-auto px-4 text-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-primary-foreground mb-6 leading-tight">
              PVRHR Solutions & Services
            </h1>
            <p className="text-xl md:text-2xl text-primary-foreground/90 mb-4 font-body max-w-3xl mx-auto">
              Trusted Recruitment & Manpower Solutions for Modern Industries
            </p>
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Button size="lg" variant="hero" asChild>
                <Link to="/services">Hire Employees</Link>
              </Button>
              <Button size="lg" variant="hero-white" asChild>
        ...
        <div className="container-narrow mx-auto">
          ...
          <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true }} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service) => (
              <motion.div key={service.title} variants={fadeInUp} className="bg-card rounded-lg p-6 card-elevated border border-border">
        ...
        <div className="container-narrow mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              ...
              <p className="text-primary-foreground/80 mt-2 font-heading font-medium">Employees Deployed</p>
            </div>
            <div>
              <AnimatedCounter end={9} suffix="+" />
              <p className="text-primary-foreground/80 mt-2 font-heading font-medium">Trusted Clients</p>
            </div>
            <div>
              <AnimatedCounter end={5000} suffix="+" />
              <p className="text-primary-foreground/80 mt-2 font-heading font-medium">Total Hiring</p>
            </div>
          </div>
        </div>
      </section>
